...
<div>
<div id="maincontain">
    <h1 class="title">四级英语听力-<span>{{year}}真题</span></h1>
...
<form @submit.prevent="submit">
     ...
     <div id="abc"></div>
    <h3>Section A</h3>
<h4>Directions: In this section, you will hear three news reports. At the end of each news report, you will hear two or three questions. Both the news report and the questions will be spoken only once. After you hear a question, you must choose the best answer from the four choices marked A), B), C) and D). Then mark the corresponding letter on Answer Sheet 1 with a single line through the centre.</h4>
<br>
<h4>Questions 1 and 2 are based on the news report you have just heard.</h4>
<br>
<div> 
    <p v-if="Questions.Q1"><input type="radio" v-model="answer.one" value="A">{{Questions.Q1[0]}}</p>
...
<br>
<div>
    <p v-if="Questions.Q2"><input type="radio" v-model="answer.two" value="A">{{Questions.Q2[0]}}</p>
...
<br>
<h4>Questions 3 and 4 are based on the news report you have just heard.</h4>
<br>
<div>
     <p v-if="Questions.Q3"><input type="radio" v-model="answer.three" value="A">{{Questions.Q3[0]}}</p>
...
<br>
<div>
    <p v-if="Questions.Q4"><input type="radio" v-model="answer.four" value="A">{{Questions.Q4[0]}}</p>
...
<br>
<h4>Questions 5 to 7 are based on the news report you have just heard.</h4>
<br>
<div>
    <p v-if="Questions.Q5"><input type="radio" v-model="answer.five" value="A">{{Questions.Q5[0]}}</p>
...
<br>
<div>
 <p v-if="Questions.Q6"><input type="radio" v-model="answer.six" value="A">{{Questions.Q6[0]}}</p>
...
<br>
<div>
 <p v-if="Questions.Q7"><input type="radio" v-model="answer.seven" value="A">{{Questions.Q7[0]}}</p>
...
<!-- B -->
<h3>Section B</h3>
<h4>Directions: In this section, you will hear two long conversations. At the end of each conversation, you will hear four questions. Both the conversation and the questions will be spoken only once. After you hear a question, you must choose the best answer from the four choices marked A), B), C) and D). Then mark the corresponding letter on Answer Sheet 1 with a single line through the centre.</h4>
<br>
<h4>Questions 8 to 11 are based on the conversation you have just heard.</h4>
<br>
<div>
 <p v-if="Questions.Q8"><input type="radio" v-model="answer.eight" value="A">{{Questions.Q8[0]}}</p>
...
<br>
<div>
 <p v-if="Questions.Q9"><input type="radio" v-model="answer.nine" value="A">{{Questions.Q9[0]}}</p>
...
<br>
<div>
 <p v-if="Questions.Q10"><input type="radio" v-model="answer.ten" value="A">{{Questions.Q10[0]}}</p>
...
<br>
<div>
 <p v-if="Questions.Q11"><input type="radio" v-model="answer.eleven" value="A">{{Questions.Q11[0]}}</p>
...
<br>
<h4>Questions 12 to 15 are based on the conversation you have just heard.</h4>
<br>
<div>
 <p v-if="Questions.Q12"><input type="radio" v-model="answer.twelve" value="A">{{Questions.Q12[0]}}</p>
...
<br>
<div>
 <p v-if="Questions.Q13"><input type="radio" v-model="answer.thirteen" value="A">{{Questions.Q13[0]}}</p>
...
<br>
<div>
 <p v-if="Questions.Q14"><input type="radio" v-model="answer.fourteen" value="A">{{Questions.Q14[0]}}</p>
...
<br>
<div>
 <p v-if="Questions.Q15"><input type="radio" v-model="answer.fifteen" value="A">{{Questions.Q15[0]}}</p>
...
<!-- C -->
<h3>Section C</h3>
<h4>Directions: In this section, you will hear three passages. At the end of each passage, you will hear three or four questions. Both the passage and the questions will be spoken only once. After you hear a question, you must choose the best answer from the four choices marked A), B), C) and D). Then mark the corresponding letter on Answer Sheet 1 with a single line through the centre.</h4>
<br>
<h4>Questions 16 to 18 are based on the passage you have just heard.</h4>
<br>
<div>
    <p v-if="Questions.Q16"><input type="radio" v-model="answer.sixteen" value="A">{{Questions.Q16[0]}}</p>
...
<br>
<div>
    <p v-if="Questions.Q17"><input type="radio" v-model="answer.seventeen" value="A">{{Questions.Q17[0]}}</p>
...
<br>
<div>
    <p v-if="Questions.Q18"><input type="radio" v-model="answer.eightteen" value="A">{{Questions.Q18[0]}}</p>
...
<br>
<h4>Questions 19 to 21 are based on the passage you have just heard.</h4>
<br>
<div>
    <p v-if="Questions.Q19"><input type="radio" v-model="answer.nineteen" value="A">{{Questions.Q19[0]}}</p>
...
<br>
<div>
    <p v-if="Questions.Q20"><input type="radio" v-model="answer.twenty" value="A">{{Questions.Q20[0]}}</p>
...
<br>
<div>
    <p v-if="Questions.Q21"><input type="radio" v-model="answer.twentyone" value="A">{{Questions.Q21[0]}}</p>
...
<br>
<h4>Questions 22 to 25 are based on the passage you have just heard.</h4>
<br>
<div>
    <p v-if="Questions.Q22"><input type="radio" v-model="answer.twentytwo" value="A">{{Questions.Q22[0]}}</p>
...
<br>
<div>
    <p v-if="Questions.Q23"><input type="radio" v-model="answer.twentythree" value="A">{{Questions.Q23[0]}}</p>
...
<br>
<div>
    <p v-if="Questions.Q24"><input type="radio" v-model="answer.twentyfour" value="A">{{Questions.Q24[0]}}</p>
...
<br>
<div>
    <p v-if="Questions.Q25"><input type="radio" v-model="answer.twentyfive" value="A">{{Questions.Q25[0]}}</p>
...
<button v-if="!isSubmit" type="submit" class="btn btn-primary btn-lg btn-color">提交</button>
    <div v-if="isSubmit" class="achievementbtn">
        <router-link to="/fourachievement">查看我的成绩</router-link>
    </div>
</form>
</div>
</div>
...
            };
    ...
    methods:{
        ...
        submit(){
            ...
            this.$axios.post(`http://localhost:5000/api/listen/four/check/${this.answer.handle}`,this.answer)
            .then(res => {
