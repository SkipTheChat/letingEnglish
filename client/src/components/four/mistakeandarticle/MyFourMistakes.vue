...
<form @submit.prevent="submit">
     <!-- A -->
    <h2>Section A</h2>
    <h3>Questions 1 and 2 are based on the news report you have just heard.</h3>
    <br>
<div>
    <p v-if="Questions.Q1">{{Questions.Q1[0]}}</p>
...
<div>
<p v-if="Questions.Q2">{{Questions.Q2[0]}}</p>
...
<br>
<h3>Questions 3 and 4 are based on the news report you have just heard.</h3>
<br>
<div>
    <p v-if="Questions.Q3">{{Questions.Q3[0]}}</p>
...
<div>
    <p v-if="Questions.Q4">{{Questions.Q4[0]}}</p>
...
<br>
<h3>Questions 5 to 7 are based on the news report you have just heard.</h3>
<br>
<div>
<p v-if="Questions.Q5">{{Questions.Q5[0]}}</p>
...
<div>
<p v-if="Questions.Q6">{{Questions.Q6[0]}}</p>
...
<div>
<p v-if="Questions.Q7">{{Questions.Q7[0]}}</p>
...
<br>
<h2>Section B</h2>
<h3>Questions 8 to 11 are based on the news report you have just heard.</h3>
<br>
<div>
<p v-if="Questions.Q8">{{Questions.Q8[0]}}</p>
...
<div>
<p v-if="Questions.Q9">{{Questions.Q9[0]}}</p>
...
<div>
 <p v-if="Questions.Q10">{{Questions.Q10[0]}}</p>
...
<div>
 <p v-if="Questions.Q11">{{Questions.Q11[0]}}</p>
...
<br>
<div>
 <p v-if="Questions.Q12">{{Questions.Q12[0]}}</p>
...
<div>
 <p v-if="Questions.Q13">{{Questions.Q13[0]}}</p>
...
<div>
 <p v-if="Questions.Q14">{{Questions.Q14[0]}}</p>
...
<div>
 <p v-if="Questions.Q15">{{Questions.Q15[0]}}</p>
...
<br>
<div>
    <p v-if="Questions.Q16">{{Questions.Q16[0]}}</p>
...
<div>
    <p v-if="Questions.Q17">{{Questions.Q17[0]}}</p>
...
<div>
    <p v-if="Questions.Q18">{{Questions.Q18[0]}}</p>
...
<br>
<h3>Questions 19 to 21 are based on the passage you have just heard.</h3>
<br>
<div>
    <p v-if="Questions.Q19">{{Questions.Q19[0]}}</p>
...
<div>
    <p v-if="Questions.Q20">{{Questions.Q20[0]}}</p>
...
<div>
    <p v-if="Questions.Q21">{{Questions.Q21[0]}}</p>
...
<br>
<h3>Questions 22 to 25 are based on the passage you have just heard.</h3>
<br>
<div>
    <p v-if="Questions.Q22">{{Questions.Q22[0]}}</p>
...
<div>
    <p v-if="Questions.Q23">{{Questions.Q23[0]}}</p>
...
<div>
    <p v-if="Questions.Q24">{{Questions.Q24[0]}}</p>
...
<div>
    <p v-if="Questions.Q25">{{Questions.Q25[0]}}</p>
...
            };
    ...
    methods:{
        ...
        getHistory(handle){
                // /four/personScore
                // 得到答案
                 this.$axios.get(`http://localhost:5000/api/history/four/personScore/${handle}`)
            .then(res => {
        ...
        getRightAnswer(handle){
            this.$axios.get(`http://localhost:5000/api/history/four/rightanswer/${handle}`)
                .then(res => {
